...
namespace App\Http\Controllers\API\Subscriber\Login;

//Request
use Illuminate\Http\Request;
use App\Http\Requests\Subscriber\Login\LoginRequest;
...
//Services
use App\Services\Subscriber\Login\LoginService;
...
class LoginController extends Controller
{
    ...
    public function login(LoginRequest $request)  :? JsonResponse   {
       ...
       $user = $this->service->getUserByUserName($request->input('userName'));
