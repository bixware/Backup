...
html,body{
    ...
    <body>
		...
		<center><img src="http://localhost/ering_angular/backend/storage/app/public/data/chieflist/qrcode/{{$player->qrcode}}" style="margin-top:10% !important;width:150mm;height:150mm"></center><br><p style="text-align:center;font-weight:bolder;font-size:80px;margin-top:6% !important;">{{$player->uniqueid}}</p>
