<section id="recent" class="process-page" x-data="{
    ...
    <x-app.store-user.process.sap-recon.upi-recon.filters :activeTab="$activeTab" :filtering="$filtering" :cardBanks="$cardBanks" :months="$_months" />


    <x-app.store-user.process.sap-recon.upi-recon.process-page :orderBy="$orderBy" :dataset="$dataset">
        <x-scrollable.scroll-body>
            ...
            {{-- modal --}}
            <x-app.store-user.process.sap-recon.upi-recon.modal :data="$data" :remarks="$remarks" />
            @endforeach
            @endif
        </x-scrollable.scroll-body>
    </x-app.store-user.process.sap-recon.upi-recon.process-page>
