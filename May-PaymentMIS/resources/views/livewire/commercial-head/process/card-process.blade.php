<section id="recent" class="process-page" x-data="{
    ...
    <div class="mt-2">
        <div class="my-2 d-flex d-flex-mob gap-2 align-items-center @tab('wallet') d-none @endtab">
            ...
            <x-filters.dropdown :dataset="$cardBanks" keys="bank" initialValue="SELECT A BANK" />
                                ...
                                <div class="modal-body" style="position: unset">
                                    ...
                                    <section class="d-flex" style="flex-direction: column; padding: 0 .8em;" id="">
                                        ...
                                        <div class="row mainUploadItems cash-pickup-item">
                                            ...
                                            <div class="col-lg-2 text-center my-auto">
                                                <x-viewer.widget document="{{ url('/') }}/storage/app/public/reconciliation/card-reconciliation/store-card/{{ $main->supportDocupload }}" />
                                            </div>
