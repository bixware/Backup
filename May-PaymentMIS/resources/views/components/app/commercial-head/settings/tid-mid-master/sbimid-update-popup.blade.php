<!-- Modal popup -->
<div wire:key="{{ 'sbi_upload_modal' }}" class="modal fade midupdate" wire:ignore id="exampleModalCenterThirdTab_{{ $data->sbiMIDUID }}" tabindex="1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
