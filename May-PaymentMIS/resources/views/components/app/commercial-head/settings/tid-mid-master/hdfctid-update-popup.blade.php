<!-- Modal popup -->
<div wire:key="{{ 'hdfc_upload_modal' }}" class="modal fade midupdate" wire:ignore id="exampleModalCenterFourthTab_{{ $data->hdfcTIDUID }}" tabindex="1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                ...
                <div class="modal-body" style="height: 300px !important">
                    ...
                    <div class="modal-footer">
                        ...
                        <div class="d-flex" style="gap: 3">
                            <button x-data @click="(e) => handleFormDatahdfc(e, '#exampleModalCenterFourthTab_{{ $data->hdfcTIDUID }}')" style="width: fit-content" data-id="{{ $data->hdfcTIDUID }}" type="button" id="modalSubmitButton" class="btn btn-success green">Update</button>
