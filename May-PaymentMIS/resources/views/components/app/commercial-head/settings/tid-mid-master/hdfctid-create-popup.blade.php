                ...
                <div class="modal-body" style="height: 300px !important">
                    <div class="row">
                        <div class="form-group col-lg-4">
                            ...
                            <input type="number" placeholder="Eg: 000000000..." class="form-control" id="TID" name="TID" value="" required>
                        </div>
                        <div class="form-group col-lg-4">
                            <label style="color:#800000;font-weight:600;">POS *</label>
                            <input type="number" placeholder="Eg: 000000... " class="form-control" id="POS" name="POS" value="" required>
                        </div>
                        <div class="form-group col-lg-4">
