...
}" class="modal fade setting" id="amexupload" tabindex="1" role="dialog" aria-labelledby="repo" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document" style="height:250px !important; max-width: 950px !important; padding: 2em">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h3 style="font-size: 1em; font-weight: 500; color: #000" class="mb-3">Please download the sample file for AMEX MID Import
                    <a href="{{ url('/') }}/public/sample/tidmid/amex.xlsx" download="">Download a sample
                        File</a>
                </h3>
