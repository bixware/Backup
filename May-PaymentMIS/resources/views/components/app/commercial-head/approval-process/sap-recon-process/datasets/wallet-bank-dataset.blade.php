...
<tr>
    <td class="left"> {{ !$data->transactionDate ? '' : Carbon\Carbon::parse($data->transactionDate)->format('d-m-Y') }} </td>
    ...
    {{-- <td class="right" style="text-align: right !important"> {{ intval($data->saleReconDifferenceAmount) }} </td> --}}
    <td class="right" style="text-align: right !important">{{ $data->adjAmount }}</td>
    <td class="right" style="text-align: right !important">{{ $data->reconDifference }}</td>
