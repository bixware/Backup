    ...
    <div class="p-3">
        ...
        <div class="d-flex justify-content-start align-items-center gap-3 mb-3 pb-4 flex-column flex-md-row" style="border-bottom: 2px solid #00000023">
            ...
            <div class="w-100">
                ...
                <input x-model="recon.referenceNo" type="text" data-name="slipNumber" class="form-control mt-1" id="exampleInputConfirmPassword1" placeholder="Slip No">
            </div>
        ...
        <div class="d-flex justify-content-start align-items-center gap-3 mb-3 pb-4 flex-column flex-md-row" style="border-bottom: 2px solid #00000023">
            <x-app.store-user.process.sap-recon.wallet-recon.remarks :remarks="$remarks" />
