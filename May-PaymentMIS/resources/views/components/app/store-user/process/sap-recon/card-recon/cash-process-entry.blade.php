<div class="mainFormValidaitionInputs">
    ...
    <div class="p-3">
        ...
        <div class="d-flex justify-content-start align-items-center gap-3 mb-3 pb-4 flex-column flex-md-row" style="border-top: 2px solid #00000023">
            ...
            <div class="w-mob-100" style="width: 150px; margin-top: 15px" x-data="{
        ...
        <div class="d-flex justify-content-start align-items-center gap-3 mb-3 pb-4 flex-column flex-md-row" style="border-bottom: 2px solid #00000023">
            <x-app.store-user.process.sap-recon.card-recon.remarks :remarks="$remarks" />

            <div class="d-flex justify-content-end pt-4 w-md-100" style="flex-direction: column; ">
                <label for="">Support Document Upload</label>
                <input x-on:change="recon['supportDocupload'] = Object.values($event.target.files)" type="file" data-passes-validation data-name="supportDocupload" class="form-control w-md-100" id="supportDocupload" placeholder="Slip No">
