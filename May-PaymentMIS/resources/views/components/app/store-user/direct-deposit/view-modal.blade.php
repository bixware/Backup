<div>
    <!-- Bootstrap modal -->
    <div wire:ignore.self class="modal fade" id="Main_{{ $data->directDepositUID }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            ...
            <div wire:ignore.self class="modal-content">
                ...
                <div wire:ignore.self class="modal-body">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <!-- Reason -->
                        <div class="col-md-4">
                            <label for="reason" class="form-label">Reason for Direct Deposit</label>
