        ...
        try {
            ...
            for ($i = $this->repository->startFrom; $i <= $arrayCount; $i++) {
                ...
                if ($tran_type != '' && $pkup_pt_code != '') {
                    ...
                    if (MFLinwardCashMISIciciPos::updateOrInsert($attributes, $data)) {
    ...
    public function ICICIcardUpload(Request $request) {
        ...
        try {
            for ($i = $this->repository->startFrom; $i <= $arrayCount; $i++) {
                ...
                $storedata = GeneralService::getReteckCodeUsingTIDForICICI($mid, Carbon::parse($parsed_)->format('Y-m-d'));
                ...
                if ($merCode != '' && $mid != '') {
                    ...
                    if (MFLInwardCardMISIciciPos::updateOrInsert($attributes, $data)) {
                        $this->repository->increamentInsertedCount();
                    }
                }
