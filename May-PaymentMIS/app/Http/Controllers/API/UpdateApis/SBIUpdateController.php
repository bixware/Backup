...
class SBIUpdateController extends Controller {
    ...
    public function __invoke(Request $request) {
        ...
        $validate = Validator::make($request->only(['bank']), [
            "bank" => 'required|string|min:4|in:agency,cash,cash_store,AxisCash,AxisCashReteck,HdfcCash,IdfcCash,IciciCash,Wallet_Phonepay_StoreID,Wallet_Phonepay_Terminal',
        ]);
        ...
        try {
            ...
            \Illuminate\Support\Facades\DB::transaction(function () use ($request) {
                ...
                \Illuminate\Support\Facades\DB::statement('PaymentMIS_API_Update_AllCash_StoreId_RetekCode :bank', [
                    'bank' => $request->bank
                ]);
