...
class BankStatementReconciliation extends Component implements UseExcelDataset, WithHeaders {
    ...
    public function banks(string $type) {
        return DB::select('PaymentMIS_PROC_COMMERCIALTEAM_SELECT_BankStatement_Reconciliation_Filters :procType, :store, :brand, :location', [
            'procType' => $type,
            "store" => $this->_store,
            "brand" => $this->_brand,
    ...
    public function _totals() {
        return DB::withOrderBySelect(
            storedProcedure: 'PaymentMIS_PROC_COMMERCIALTEAM_SELECT_BankStatement_Reconciliation :procType, :store, :location, :brand, :bank, :status, :from, :to',
            params: [
    ...
    public function download($value = ''): Collection|bool {
        return DB::withOrderBySelect(
            'PaymentMIS_PROC_COMMERCIALTEAM_SELECT_BankStatement_Reconciliation_Export :procType, :store, :location, :brand, :bank, :status, :from, :to',
            [
    ...
    public function render() {
        ...
        return view('livewire.commercial-team.reports.bank-statement-reconciliation ', [
