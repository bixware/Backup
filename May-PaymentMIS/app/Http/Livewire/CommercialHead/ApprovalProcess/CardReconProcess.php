...
class CardReconProcess extends Component implements UseExcelDataset, WithFormatting, WithHeaders {
     ...
     * @var string
     */
    public $export_file_name = 'Payment_MIS_Approved_Process_Card_Reconciliation';
    ...
    public function render() {
        ...
        return view('livewire.commercial-head.approval-process.card-recon-process ', [
    ...
    public function download($value = ''): Collection|bool {
        ...
        // Procedure Instance
        return DB::infinite(
            storedProcedure: 'PaymentMIS_PROC_SELECT_COMMERCIALHEAD_Tracker_Card_Reconciliation_Approved_Process :procType, :store, :from, :to',
            params: $params,
