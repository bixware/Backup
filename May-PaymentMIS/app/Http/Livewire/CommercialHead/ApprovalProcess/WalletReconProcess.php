...
class WalletReconProcess extends Component implements UseExcelDataset, WithFormatting, WithHeaders {
    ...
    public function download($value = ''): Collection|bool {
        ...
        // Procedure Instance
        return DB::infinite(
            storedProcedure: 'PaymentMIS_PROC_SELECT_COMMERCIALHEAD_Tracker_Wallet_Reconciliation_Approved_Process :procType, :store, :from, :to',
            params: $params,
