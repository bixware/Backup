...
class MposReconciliation extends Component implements UseExcelDataset, WithFormatting, WithHeaders {
    ...
    public function filtersSyncDataset(string $type) {
        ...
        return DB::select(
            'PaymentMIS_PROC_SELECT_COMMERCIALHEAD_Tracker_Mpos_Reconciliation_Filters :procType, :store, :brand, :location',
            $params
        );
    }
    ...
    public function getTotals() {
        return DB::withOrderBySelect(
            'PaymentMIS_PROC_SELECT_COMMERCIALHEAD_Tracker_Mpos_Reconciliation :procType, :store, :brand, :location, :status, :timeline, :from, :to',
            [
                'procType' => "get_totals",
                'store' => $this->_store,
                'brand' => $this->_brand,
