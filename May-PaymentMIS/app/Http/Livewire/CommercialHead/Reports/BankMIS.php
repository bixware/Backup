...
class BankMIS extends Component implements UseExcelDataset, WithHeaders {
    ...
    public function stores() {
        return DB::withOrderBySelect('PaymentMIS_PROC_SELECT_COMMERCIALHEAD_BankMIS_All_Bank_Reports_MIS :procType, :storeId,:bankName, :from, :to', [
    ...
    public function download(string $value = ''): Collection|bool {
        ...
        return DB::withOrderBySelect(
            'PaymentMIS_PROC_SELECT_COMMERCIALHEAD_BankMIS_All_Bank_Reports_MIS :procType, :storeId, :bankName, :from, :to',
            $params,
            $this->perPage,
            $this->orderBy
        );
