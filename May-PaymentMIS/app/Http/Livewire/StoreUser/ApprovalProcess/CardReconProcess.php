...
class CardReconProcess extends Component implements WithHeaders, WithFormatting, UseExcelDataset {
    ...
    public function getData() {
        ...
        return DB::withOrderBySelect(
            storedProcedure: 'PaymentMIS_PROC_SELECT_STOREUSER_Approved_Process_Card_Reconciliation :procType, :store, :from, :to',
            params: $params,
    ...
    public function download(string $type = ''): Collection|bool {
        return DB::withOrderBySelect(
            'PaymentMIS_PROC_SELECT_STOREUSER_Approved_Process_Card_Reconciliation :procType, :store, :from, :to',
            [
                'procType' => 'export',
                'store' => auth()->user()->storeUID,
                'from' => $this->startDate,
