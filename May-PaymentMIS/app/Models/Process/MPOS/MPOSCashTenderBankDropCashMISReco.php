...
class MPOSCashTenderBankDropCashMISReco extends Model {
    use HasFactory;
    ...
    protected $table = 'MFL_Outward_MPOSCashTenderBankDropCashMISReco';
    ...
    protected $primaryKey = 'CashTenderBkDrpUID';
