...
GO
/****** Object:  StoredProcedure [dbo].[SF_REQUEST_LIST]    Script Date: 02-04-2024 18:14:07 ******/
SET ANSI_NULLS ON
GO
...
AS
 BEGIN
  SET NOCOUNT ON;
	...
	SELECT distinct WF.*,TS.statusDescription,WFSR.workFlowStageName as RemarWorkFlowStageName 
	...
	-- order descending method changed by thiraviyam
	ORDER BY workFlowRequestUID DESC
