<div>
    <section class="ftco-section" style="background-image: url('assets/images/shopbg2.jpg'); min-height: 100vh;">
        <x-spinner.spinner />
                        ...
                        <div class="login-wrap p-4 p-md-5">
                            ...
                            <form wire:submit.prevent="sendResetLink">
                                ...
                                <div class="login-buttons mb-1">
                                    <button type="submit" class="btn btn-secondary btn-block btn-lg" style="cursor:pointer;">Submit</button>
                                </div>
                                {{-- <div class="login-buttons mb-1">
