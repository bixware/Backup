        ...
        <div wire:ignore.self class="modal-content">
            <form wire:submit="save" class="col-lg-12" enctype="multipart/form-data">
                <div class="modal-header">
                    <h5 class="modal-title">Invoice Month Upload</h5>
                ...
                <div wire:ignore.self class="modal-body">
                    <div class="row">
                        ...
                        <h3 style="font-weight: 450 !important; color: #000 !important">Please note that the data must be in certain format for the import to process correctly <a href="{{ url('/') }}/public/samples/LE&OP.csv" download>Download a sample CSV</a></h3>
                        <div class="drag-area">
                ...
                <div class="modal-footer">
                    <button wire:loading.class="when_loading" id="uploadBtn" type="submit" class="btn btn-primary  importxls ">Import</button>
                </div>
            </form>
        </div>
    </div>
