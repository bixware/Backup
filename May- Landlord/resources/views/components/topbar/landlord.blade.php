                ...
                {{-- <div class="search-field">
                    <form class="d-flex align-items-center h-100" action="#">
                        <div class="input-group">
                            <input type="text" class="form-control border-1 text-uppercase" value="User Panel">
                        </div>
                    </form>
                </div> --}}
            </div>
                ...
                <ul class="navbar-nav navbar-nav-right">
                    <li class="nav-item nav-profile dropdown">
                        ...
                        <div class="dropdown-menu navbar-dropdown dropdown-menu-right p-0 border-0 font-size-sm" aria-labelledby="profileDropdown" data-x-placement="bottom-end">
                            <div class="p-2">
                                <h5 class="dropdown-header text-uppercase ps-2 text-dark">Landlord Panel</h5>

                                <a class="dropdown-item py-1 d-flex align-items-center justify-content-between" href="{{ url('/') }}/landlord/changepwd">Change Password </a>
...
<nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row" style="z-index: 2 !important" id="desktop-header">
    ...
    <div class="navbar-menu-wrapper d-flex align-items-stretch">
        ...
        {{-- <div class="search-field w-50">
            <form class="d-flex align-items-center h-100" action="#">
                <div class="input-group">
                    <input type="text" class="form-control border-1 dropdown-header text-uppercase ps-2 text-dark" value="user Panel"><i class="input-group-text mdi mdi-magnify" style="display: none"></i>
                </div>
            </form>
        </div> --}}
        <ul class="navbar-nav navbar-nav-left">
        ...
        <ul wire:key="{{ rand() }}" class="navbar-nav navbar-nav-right">
            <li class="nav-item nav-profile relative" x-data="{
                ...
                <div x-ref="panel" x-show="open" x-transition.origin.top.left x-on:click.outside="close($refs.button)" :id="$id('dropdown-button')" style="display: none" class="navbar-dropdown dropdown-menu-right p-0 border-0 font-size-sm">
                    <div class="p-2">
                        <h5 class="dropdown-header text-uppercase ps-2 text-dark">Landlord Panel</h5>
