    ...
    <div wire:ignore.self class="modal-dialog modal-dialog-centered" role="document">
        <div wire:ignore.self class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Season Plan Upload</h5>
            ...
            <div wire:ignore.self class="modal-body">
                <div class="row">
                    <form wire:submit="save" class="col-lg-12" enctype="multipart/form-data">
                        <h3 style="font-weight: 450 !important; color: #000 !important">Please note that the data must be in certain format for the import to process correctly <a href="{{ url('/') }}/public/samples/seasonplan.csv" download>Download a sample CSV</a></h3>
                        <div class="drag-area">
