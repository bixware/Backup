            ...
            <div wire:ignore.self class="modal-body">
                <div class="row">
                    <form wire:submit="save" class="col-lg-12" enctype="multipart/form-data">
                        ...
                        <h3 style="font-weight: 450 !important; color: #000 !important">Please note that the data must be in certain format for the import to process correctly <a href="{{ url('/') }}/public/samples/AETargetFile.csv" download>Download a sample CSV</a></h3>
                        <div class="drag-area">
