...
}" class="ftco-section" style="background-image: url('assets/images/login-bg-red1.png'); min-height: 100vh;" x-init="() => {
        ...
        <div class="row justify-content-center">
            <div class="col-md-12 col-lg-8">
                <div class="wrap d-md-flex">
                    <div class="img" style="background-image: url('assets/images/bgo.png');">
                    </div>
