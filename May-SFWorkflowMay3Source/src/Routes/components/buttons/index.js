      ...
      <div className="button-wrapper">
         ...
         <div className="row">
            ...
            >
               ...
               <Fab size="large" variant="circular" color="primary" className="text-white mr-15 mb-10" aria-label="add">
                  <i className="zmdi zmdi-settings"></i>
               </Fab>
               <Fab size="small" variant="circular" color="primary" className="text-white mr-15 mb-10" aria-label="add">
                  <i className="zmdi zmdi-settings"></i>
               </Fab>
               <Fab size="large" variant="circular" className="btn-danger text-white mr-15 mb-10" aria-label="add">
                  <i className="zmdi zmdi-favorite"></i>
               </Fab>
               <Fab size="small" variant="circular" className="btn-danger text-white mr-15 mb-10" aria-label="add">
                  <i className="zmdi zmdi-favorite"></i>
               </Fab>
               <Fab size="large" variant="circular" className="btn-info text-white mr-15 mb-10" aria-label="add">
                  <i className="zmdi zmdi-help-outline"></i>
               </Fab>
               <Fab size="small" variant="circular" className="btn-info text-white mr-15 mb-10" aria-label="add">
                  <i className="zmdi zmdi-help-outline"></i>
               </Fab>
            </RctCollapsibleCard>
            <RctCollapsibleCard
         ...
         >
            ...
            <div className="mb-30">
               <Fab size="large" variant="circular" className="btn-twitter mr-15 mb-10 text-white" aria-label="add">
                  <i className="zmdi zmdi-twitter"></i>
               </Fab>
               <Fab size="large" variant="circular" className="btn-google mr-15 mb-10 text-white" aria-label="add">
                  <i className="zmdi zmdi-google"></i>
               </Fab>
               <Fab size="large" variant="circular" className="btn-facebook mr-15 mb-10 text-white" aria-label="add">
                  <i className="zmdi zmdi-facebook"></i>
               </Fab>
               <Fab size="large" variant="circular" className="btn-pinterest mr-15 mb-10 text-white" aria-label="add">
                  <i className="zmdi zmdi-pinterest"></i>
               </Fab>
               <Fab size="large" variant="circular" className="btn-instagram mr-15 mb-10 text-white" aria-label="add">
                  <i className="zmdi zmdi-instagram"></i>
               </Fab>
               <Fab size="large" variant="circular" className="btn-rss mr-15 mb-10 text-white" aria-label="add">
                  <i className="zmdi zmdi-rss"></i>
               </Fab>
               <Fab size="large" variant="circular" className="btn-tumblr mr-15 mb-10 text-white" aria-label="add">
                  <i className="zmdi zmdi-tumblr"></i>
               </Fab>
               <Fab size="large" variant="circular" className="btn-linkedin mr-15 mb-10 text-white" aria-label="add">
                  <i className="zmdi zmdi-linkedin"></i>
               </Fab>
               <Fab size="large" variant="circular" className="btn-dribbble mr-15 mb-10 text-white" aria-label="add">
                  <i className="zmdi zmdi-dribbble"></i>
               </Fab>
               <Fab size="large" variant="circular" className="btn-skype mr-15 mb-10 text-white" aria-label="add">
                  <i className="zmdi zmdi-skype"></i>
               </Fab>
               <Fab size="large" variant="circular" className="btn-youtube mr-15 mb-10 text-white" aria-label="add">
                  <i className="zmdi zmdi-youtube"></i>
               </Fab>
               <Fab size="large" variant="circular" className="btn-github mr-15 mb-10 text-white" aria-label="add">
