...
function AvatarsComponent(props) {
   return (
      <div className="avatar-wrapper">
         <PageTitleBar title={<IntlMessages id="sidebar.avatars" />} match={props.match} />
         <div className="row">
            <RctCollapsibleCard
            ...
            >
               <ul className="list-inline d-flex align-items-center justify-content-around flex-wrap">
                  <li className="list-inline-item">
                     <Avatar alt="user 1" src={`${process.env.PUBLIC_URL}/assets/images/img/user-5.jpg`} className="size-120 rounded-circle border-primary rct-notify" />
                  </li>
                  <li className="list-inline-item">
                     <Avatar alt="user 2" src={`${process.env.PUBLIC_URL}/assets/images/img/user-2.jpg`} className="size-100 rounded-circle border-success rct-notify" />
                  </li>
                  <li className="list-inline-item">
                     <Avatar alt="user 3" src={`${process.env.PUBLIC_URL}/assets/images/img/user-3.jpg`} className="size-80 rounded-circle border-warning rct-notify" />
                  </li>
                  <li className="list-inline-item">
                     <Avatar alt="user 4" src={`${process.env.PUBLIC_URL}/assets/images/img/user-4.jpg`} className="size-60 rounded-circle border-danger rct-notify" />
                  </li>
                  <li className="list-inline-item">
                     <Avatar alt="user 4" src={`${process.env.PUBLIC_URL}/assets/images/img/user-1.jpg`} className="rounded-circle border-info rct-notify" />
                  </li>
               </ul>
            </RctCollapsibleCard>
            <RctCollapsibleCard
