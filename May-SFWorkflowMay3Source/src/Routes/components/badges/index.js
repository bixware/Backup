   ...
   return (
      <div className="badges-wrapper">
         ...
         <div className="row">
            ...
            >
               <MatBadge badgeContent={4} color="primary" className="mr-20 mb-10" overlap="rectangular">
                  <i className="zmdi zmdi-email zmdi-hc-2x"></i>
               </MatBadge>
               <MatBadge badgeContent={4} color="primary" className="mr-20 mb-10" overlap="rectangular">
                  <i className="zmdi zmdi-notifications-active zmdi-hc-2x"></i>
               </MatBadge>
               <MatBadge className="mr-20 mb-10" badgeContent={4} color="primary" overlap="rectangular">
