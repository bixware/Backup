...
function DataEntryList(props) {
  ...
  const handleView = (selectedData) => {
    ...
    if (selectedData.workFlowName === "Material Code Creation") {
      history.push({
        pathname: "/app/user/dataentrylist/view-material-approval",
        state: { selectedData },
      });
    } else if (selectedData.workFlowName === "Cost Price Update") {
      history.push({
        pathname: "/app/user/dataentrylist/view-approval",
        state: { selectedData },
      });
    } else if (selectedData.workFlowName === "Receipe Creation") {
      history.push({
        pathname: "/app/user/dataentrylist/view-rc-approval",
        state: { selectedData },
      });
    } else if (selectedData.workFlowName === "NSO Store Live") {
      history.push({
        pathname: "/app/user/dataentrylist/view-nso-approval",
        state: { selectedData },
      });
    }
  ...
  return (
    <div className="data-table-wrapper">
      {loading ? (
        ...
        <RctCollapsibleCard heading="Data Entry List" fullBlock>
          <div
