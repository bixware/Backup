...
function RequestList(props) {
  ...
  const handleView = (selectedData) => {
    ...
    if (selectedData.workFlowName === "Material Code Creation") {
      history.push({
        pathname: "/app/user/requestlist/view-material-request",
        state: { selectedData },
      });
    } else if (selectedData.workFlowName === "Cost Price Update") {
      history.push({
        pathname: "/app/user/requestlist/view-request",
        state: { selectedData },
      });
    } else if (selectedData.workFlowName === "Receipe Creation") {
      history.push({
        pathname: "/app/user/requestlist/view-rc-request",
        state: { selectedData },
      });
    } else if (selectedData.workFlowName === "NSO Store Live") {
      history.push({
        pathname: "/app/user/requestlist/view-nso-request",
        state: { selectedData },
      });
    }
