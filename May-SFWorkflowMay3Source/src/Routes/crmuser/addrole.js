...
const AddRole = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    form_data.append("fromDate", fDate);
    form_data.append("toDate", tDate);
    ...
    try {
      const response = await apiFormDataPost("user/sfcreatecpu", form_data);
      if (response) {
        setSuccess(true);
        setLoading(false);
      } else {
  ...
  return (
    <RctCollapsibleCard>
            ...
            <div className="row">
              <div className="col-sm-6">
                <FormGroup>
                  <Label for="Todate">
                    Price Change From{"  "}
                    <span style={{ color: "red" }}>*</span> - Price Change To
                    {"  "}
                    <span style={{ color: "red" }}>*</span>
                  </Label>
                  <DateRangePicker
      ...
      <SweetAlert
        ...
        onConfirm={() => onConfirm()}
      >
        Cost Price Update added Successfully!
      </SweetAlert>
    </RctCollapsibleCard>
  );
};
