...
import EntryRequestList from "Routes/crmuser/Listpage/entryrequestlist";


const EntryRequestRoutes = ({ match }) => (
  <div className="Crm-wrapper">
    <Switch>
      {/* <Redirect exact from={`${match.url}/`} to={`${match.url}/dashboard`} /> */}
      <Route exact path={`${match.url}`}  component={EntryRequestList} /> 
...
export default EntryRequestRoutes;
