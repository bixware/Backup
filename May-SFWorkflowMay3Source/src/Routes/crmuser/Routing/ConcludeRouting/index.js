...
import Conclude from "Routes/crmuser/Listpage/conclude";

const ConcludeRoutes = ({ match }) => (
  <div className="Crm-wrapper">
    <Switch>
      {/* <Redirect exact from={`${match.url}/`} to={`${match.url}/dashboard`} /> */}
      <Route exact path={`${match.url}`}  component={Conclude} /> 
