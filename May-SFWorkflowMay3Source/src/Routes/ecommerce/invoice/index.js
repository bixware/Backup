               ...
               <RctCard>
                  <div className="invoice-head text-right">
                     <ul className="list-inline">
                        ...
                        <li><a href="!#" onClick={e => e.preventDefault()}><i className="mr-10 ti-printer"></i> Print</a></li>
                     </ul>
                  </div>
                  <div className="p-50">
                     <div className="d-flex justify-content-between mb-50">
                        <div className="sender-address">
                           <div className="invoice-logo mb-30">
                              <img src={`${process.env.PUBLIC_URL}/assets/images/img/invoice-logo.png`} alt="session-logo" className="img-fluid" width="140" height="37" />
                           </div>
                     ...
                     <div className="note-wrapper row">
                        ...
                        <div className="totle-amount col-sm-12 col-md-4 text-right">
                           ...
                           <Button variant="contained" className="btn-success text-white btn-icon"><i className="ti-wallet mr-10"></i> <IntlMessages id="components.payNow" /></Button>
                        </div>
                     </div>
                  </div>
               </RctCard>
