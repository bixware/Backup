...
import { spaceUsed } from '../data';

export default function MiscellaneousWidgets(props) {
   return (
      <div className="miscellaneous-widgets-wrapper">
         <PageTitleBar title={<IntlMessages id="sidebar.miscellaneous" />} match={props.match} />
         <div className="row">
