		...
		<div className="media-listing">
			<ul className="list-unstyled">
				<li className="media border-bottom">
					<img
                  src={`${process.env.PUBLIC_URL}/assets/images/avatars/user-1.jpg`}
				...
				<li className="media border-bottom">
					<img
                  src={`${process.env.PUBLIC_URL}/assets/images/avatars/user-2.jpg`}
						className="rounded-circle mr-20 img-fluid"
						alt="user profile"
						width="60"
						height="60"
					...
					<div className="media-body">
						...
						<div className="img-post">
							<img
                        src={`${process.env.PUBLIC_URL}/assets/images/img/weather-1.png`}
				...
				<li className="media border-bottom">
					<img
                  src={`${process.env.PUBLIC_URL}/assets/images/avatars/user-3.jpg`}
						className="rounded-circle mr-20 img-fluid"
						alt="user profile"
						width="60"
						height="60"
				...
				<li className="media border-bottom">
					<img
                  src={`${process.env.PUBLIC_URL}/assets/images/avatars/user-4.jpg`}
						className="rounded-circle mr-20 img-fluid"
						alt="user profile"
						width="60"
						height="60"
					...
					<div className="media-body">
						...
						<ul className="list-unstyled row no-gutters">
							<li className="col-sm-6 col-md-3 mb-15 d-xxs-half-block">
								<img
                           src={`${process.env.PUBLIC_URL}/assets/images/img/gallery-1.jpg`}
									className="img-fluid"
									width="200"
									height="200"
									alt="gallery post"
							...
							<li className="col-sm-6 col-md-3 mb-15 d-xxs-half-block">
								<img
                           src={`${process.env.PUBLIC_URL}/assets/images/img/gallery-2.jpg`}
									className="img-fluid"
									width="200"
									height="200"
									alt="gallery post"
							...
							<li className="col-sm-6 col-md-3 mb-15 d-xxs-half-block">
								<img
                           src={`${process.env.PUBLIC_URL}/assets/images/img/gallery-3.jpg`}
									className="img-fluid"
									width="200"
									height="200"
									alt="gallery post"
							...
							<li className="col-sm-6 col-md-3 mb-15 d-xxs-half-block">
								<img
									src={`${process.env.PUBLIC_URL}/assets/images/img/gallery-4.jpg`}
									className="img-fluid"
									width="200"
									height="200"
									alt="gallery post"
                  ...
                  src={`${process.env.PUBLIC_URL}/assets/images/avatars/user-5.jpg`}
					...
					<div className="media-body">
						...
						<div className="media media-full">
							<img
                        src={`${process.env.PUBLIC_URL}/assets/images/img/gallery-6.jpg`}
