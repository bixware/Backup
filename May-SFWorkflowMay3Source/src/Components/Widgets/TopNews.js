...
const newsData = [
   {
      id: 1,
      newsSrc: `${process.env.PUBLIC_URL}/assets/images/img/news-slide-1.jpg`,
   ...
   {
      id: 2,
      newsSrc: `${process.env.PUBLIC_URL}/assets/images/img/news-slide-2.jpg`,
   ...
   {
      id: 3,
      newsSrc: `${process.env.PUBLIC_URL}/assets/images/img/news-slide-3.jpg`,
   ...
   {
      id: 4,
      newsSrc: `${process.env.PUBLIC_URL}/assets/images/img/news-slide-4.jpg`,
   ...
   {
      id: 5,
      newsSrc: `${process.env.PUBLIC_URL}/assets/images/img/news-slide-5.jpg`,
...
function TopNews() {
   const [newSettings1, setNewSettings1] = useState(undefined);
   const [newSettings2, setNewSettings2] = useState(undefined);
   useEffect(() => {
      setNewSettings1(settings1)
      setNewSettings2(settings2)
   ...
   let settings1 = {
      ...
      fade: true,
      adaptiveHeight: true,
      ref: (slider) => (settings1 = slider),
      asNavFor: newSettings2,
   };
   let settings2 = {
      slidesToShow: 4,
      slidesToScroll: 1,
      ...
      cssEase: "linear",
      focusOnSelect: true,
      ref: (slider) => (settings2 = slider),
      asNavFor: newSettings1,
      rtl: false,
      adaptiveHeight: true,
      responsive: [
         {
