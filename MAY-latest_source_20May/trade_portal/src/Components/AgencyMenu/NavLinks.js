...
let navlinks = {
   ...
   category2: [
      ...
      {
         "menu_title": "balance confirmation",
      ...
      } */
      {
         ...
         // [
         //    {
         //       "path": "/admin/customerledger",
         //       "menu_title": "customer ledger",
         //       "new_item": false,
         //        /* exact: true */
         //    },
         //    {
         //       "path": "/admin/creditdebitnotesummary",
         //       "menu_title": "creditdebit note summary",
         //       "new_item": false,
         //        /* exact: true */
         //    }
         // ]
