...
const AddNewUserForm = ({
  ...
  const changeHandler = (e) => {
    onChangeAddNewUserDetails("budgate", e.target.value);
        ...
        <div className="col-lg-12 d-flex">
          <FormGroup className="col-lg-4">
            ...
            <input
              ...
              value={addNewUserDetails.employeeName}
              onChange={(e) =>
                onChangeAddNewUserDetails("employeeName", e.target.value)
              }
          ...
          <FormGroup className="col-lg-4">
            ...
            <input
              type="text"
              value={addNewUserDetails.storeCode}
              onChange={(e) =>
                onChangeAddNewUserDetails("storeCode", e.target.value)
              }
          ...
          <FormGroup className="col-lg-4">
            ...
            <input
              type="text"
              value={addNewUserDetails.storeName}
              onChange={(e) =>
                onChangeAddNewUserDetails("storeName", e.target.value)
              }
        ...
        <div className="col-lg-12 d-flex">
          <FormGroup className="col-lg-4">
            ...
            <input
              ...
              onChange={(e) =>
                onChangeAddNewUserDetails("designation", e.target.value)
              }
          ...
          <FormGroup className="col-lg-4">
            ...
            <input
              type="date"
              value={addNewUserDetails.dateOfJoin}
              onChange={(e) =>
                onChangeAddNewUserDetails("dateOfJoin", e.target.value)
              }
              className="form-control"
        ...
        <div className="col-lg-12 d-flex">
          <FormGroup className="col-lg-4">
            ...
            <input
              ...
              minLength={2}
              maxLength={2}
              value={addNewUserDetails.age}
              onChange={(e) => onChangeAddNewUserDetails("age", e.target.value)}
          ...
          <FormGroup className="col-lg-4">
            ...
            <select
              ...
              onChange={(e) =>
                onChangeAddNewUserDetails("gender", e.target.value)
              }
              tabIndex="11"
              required
            >
      ...
      <div className="row">
        <div className="col-lg-12 d-flex">
          <FormGroup className="col-lg-4">
            ...
            <input
              type="text"
              value={addNewUserDetails.emailid}
              onChange={(e) =>
                onChangeAddNewUserDetails("email", e.target.value)
              }
          ...
          <FormGroup className="col-lg-4">
            ...
            <input
              ...
              value={addNewUserDetails.qualification}
              onChange={(e) =>
                onChangeAddNewUserDetails("qualification", e.target.value)
              }
      ...
      <div className="row mt-3">
        <div className="col-lg-12 d-flex">
          <FormGroup className="col-lg-4">
            ...
            <input
              type="text"
              value={addNewUserDetails.currentOrg}
              onChange={(e) =>
                onChangeAddNewUserDetails("currentOrg", e.target.value)
              }
          ...
          <FormGroup className="col-lg-4">
            ...
            <input
              type="text"
              value={addNewUserDetails.totalexperience}
              onChange={(e) =>
                onChangeAddNewUserDetails("totalexperience", e.target.value)
              }
          ...
          <FormGroup className="col-lg-4">
            ...
            <input
              ...
              value={addNewUserDetails.currentNetInhand}
              onChange={(e) =>
                onChangeAddNewUserDetails("currentNetInhand", e.target.value)
              }
        ...
        <div className="col-lg-12 d-flex">
          <FormGroup className="col-lg-4">
            ...
            <input
              type="text"
              onKeyPress={(e) => current(e)}
              value={addNewUserDetails.proposedNetInhand}
              onChange={(e) =>
                onChangeAddNewUserDetails("proposedNetInhand", e.target.value)
              }
          ...
          <FormGroup className="col-lg-4">
            ...
            <select
              className="form-control"
              name="weeklyOff"
              value={addNewUserDetails.weeklyOff}
              onChange={(e) =>
                onChangeAddNewUserDetails("weeklyOff", e.target.value)
              }
              tabIndex="11"
              required
            >
          ...
          <FormGroup className="col-lg-4">
            ...
            <input
              type="text"
              value={addNewUserDetails.shiftTiming}
              onChange={(e) =>
                onChangeAddNewUserDetails("shiftTiming", e.target.value)
              }
        ...
        <div className="col-lg-12 d-flex">
          <FormGroup className="col-lg-4">
            ...
            <select
              className="form-control"
              name="budgate"
              value={addNewUserDetails.budgate}
              // onChange={(e) =>
              //   onChangeAddNewUserDetails("budgate", e.target.value)
              // }
          ...
          {isReplacementVisible ? (
            <FormGroup className="col-lg-4">
              ...
              <input
                type="text"
                value={addNewUserDetails.replacementCode}
                onChange={(e) =>
                  onChangeAddNewUserDetails("replacementCode", e.target.value)
                }
          ...
          {isReplacementVisible ? (
            <FormGroup className="col-lg-4">
              ...
              <input
                type="text"
                value={addNewUserDetails.replacementName}
                onChange={(e) =>
                  onChangeAddNewUserDetails("replacementName", e.target.value)
                }
        ...
        <div className="col-lg-12 d-flex">
          <FormGroup className="col-lg-4">
            ...
            <input
              type="text"
              onKeyPress={(e) => NameValidation(e)}
              value={addNewUserDetails.referredBy}
              onChange={(e) =>
                onChangeAddNewUserDetails("referredBy", e.target.value)
              }
          ...
          <FormGroup className="col-lg-4">
            ...
            <input
              type="text"
              onKeyPress={(e) => NameValidation(e)}
              value={addNewUserDetails.managerName}
              onChange={(e) =>
                onChangeAddNewUserDetails("managerName", e.target.value)
              }
