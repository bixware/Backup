...
@Component({
  selector: 'app-searchquarter',
  templateUrl: './searchquarter.component.html',
  styleUrls: ['./searchquarter.component.scss']
})
export class SearchquarterComponent implements OnInit {
  ...
  onGridReady(params): void {
    ...
    this.dummy.PROC_TYPE = 'SELECT_QUARTER_SEARCH_LOG';
